...
define(function (require, exports, module) {
  "use strict";
  /*
   * Simple extension that adds an "Edit > New Bootstrap Document" menu item
   * to insert an Bootstrap HTML "skeleton" at cursor position
   */
  ...
  function _getLatestBootstrap() {
    ...
    $.ajax({
      ...
      success: function(data) {
        result.resolve(data.tag_name.replace(/^v/, ""));
      },
      error: function() {
  ...
  function _inserthtmlSkelly() {
    ...
    var htmlSkelly = "<!DOCTYPE html>\n<html lang=''>\n<head>\nindent-size<meta charset='UTF-8'>\n" +
        ...
        "indent-size<!--[if IE]>\nindent-sizeindent-size<script src='https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js'></script>\n" +
        "indent-sizeindent-size<script src='https://cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.min.js'></script>\nindent-size<![endif]-->\n" +
  ...
  AppInit.appReady(function () {
    ...
    CommandManager.register("New Bootstrap Document", EXTENSION_ID, _inserthtmlSkelly);
